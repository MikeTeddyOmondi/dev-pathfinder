      ...
      <div className='container flex flex-col justify-center px-6 py-6 mx-auto sm:py-12'>
        <div className='grid gap-10 lg:grid-cols-2'>
          ...
          <div className='flex flex-col justify-center'>
            <div className='flex space-x-3'>
              <span className='px-3 py-1 text-sm rounded-full bg-emerald-100 text-emerald-600'>
                Engineering
              </span>
              <span className='px-3 py-1 text-sm rounded-full bg-amber-100 text-amber-600'>
                Design
              </span>
            </div>
        ...
        <div className='grid mt-5 lg:grid-cols-3 gap-y-14 lg:gap-10'>
          ...
          <div>
            ...
            <div className='flex mt-5 space-x-3'>
              <span className='px-3 py-1 text-sm rounded-full bg-fuchsia-100 text-fuchsia-600'>
                Product
              </span>
              <span className='px-3 py-1 text-sm rounded-full bg-emerald-100 text-emerald-600'>
                Engineering
            ...
            <p className='mt-3 text-gray-500'>
              Agile development burn rate buyer strategy founders user
              experience customer. Termsheet series A financing direct mailing
              infrastructure research &amp; development twitter.
            </p>
            <div className='flex mt-5 space-x-3'>
          ...
          <div>
            ...
            <p className='mt-3 text-gray-500'>
              ...
              customer. Termsheet series A financing direct mailing
              infrastructure research &amp; development twitter.
            </p>
            <div className='flex mt-5 space-x-3'>
              <div className='flex-shrink-0'>
